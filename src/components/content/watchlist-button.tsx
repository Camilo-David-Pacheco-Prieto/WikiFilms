        ...
        <>
          ...
          <div className="absolute left-0 top-full z-20 mt-1 w-44 rounded-md border border-border-subtle bg-surface py-1 shadow-lg">
            <button
              ...
              className="flex w-full items-center gap-2 px-4 py-2 text-sm text-text-secondary transition-colors hover:bg-muted hover:text-text-primary disabled:cursor-default disabled:text-text-secondary active:bg-muted/80"
            >
            ...
            {currentStatus && (
              <>
                ...
                <button
                  onClick={remove}
                  className="flex w-full items-center gap-2 px-4 py-2 text-sm text-text-secondary transition-colors hover:bg-muted hover:text-text-primary active:bg-muted/80"
                >
